...
from roi_data_layer.minibatch_mgdl import get_minibatch, get_minibatch
...
class roibatchLoader(data.Dataset):
  ...
  def __getitem__(self, index):
    ...
    blobs = get_minibatch(minibatch_db, self._num_classes,
        seg_return=self.seg_return, is_training=self.training)
    ...
    if self.training:
        ...
        if self.seg_return:
            ...
            return padding_data, im_info, gt_boxes_padding, num_boxes, seg_map, image_id
        elif self.path_return:
            return padding_data, im_info, gt_boxes_padding, num_boxes, blobs['path'], blobs['flipped'], image_id
        else:
            return padding_data, im_info, gt_boxes_padding, num_boxes, blobs['path'], image_id
        ...
        return data, im_info, gt_boxes, num_boxes, blobs['path'], image_id
